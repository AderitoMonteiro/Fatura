...
public class Oferta {
	...
	List<ofertaContainer> ofertaContainer;
	...
	public Oferta(String tipoDoc, String venda, String numeroDoc,
			...
			List<com.oferta.ofertaContainer> ofertaContainer) {
		super();
		...
		this.ofertaContainer = ofertaContainer;
	}
	...
	public List<ofertaContainer> getOfertaContainer() {
		return ofertaContainer;
	}


	public void setOfertaContainer(List<ofertaContainer> ofertaContainer) {
		this.ofertaContainer = ofertaContainer;
	}
