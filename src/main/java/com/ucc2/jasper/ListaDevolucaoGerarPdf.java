...
public class ListaDevolucaoGerarPdf {

	

	public  byte[] GerarPdfListaDevolucao(List<Devolucao> faturaRecibo){
		
		byte[] output = null;
		
		try {

		String FaturaReciboSubReport_jrxml = "C:\\Jasper\\Devolucao\\DevolucaoContainerSubReport.jrxml";
		String FaturaReciboSubReport_jasper = "C:\\Jasper\\Devolucao\\DevolucaoContainerSubReport.jasper";			
		String FaturaReciboReport_jrxml = "C:\\Jasper\\Devolucao\\Devolucao.jrxml";
		String FaturaReciboReport_jasper = "C:\\Jasper\\Devolucao\\Devolucao.jasper";		
		String FaturaReciboReport_jrprint = "C:\\Jasper\\Devolucao\\Devolucao.jrprint";			
		String caminhoReport_pdf = "C:\\Jasper\\Devolucao\\pdf\\";
		...
		caminhoReport_pdf = caminhoReport_pdf + "devolucao_"+dataRand+".pdf";	
		...
		parameters.put("DevolucaoContainerSubReport", subreport);
