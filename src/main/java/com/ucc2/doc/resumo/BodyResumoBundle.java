...
public class BodyResumoBundle {
	...
	private String Taxa;
	private ItemsBundle[] ItemsBundle;

	public BodyResumoBundle() {
		super();
		// TODO Auto-generated constructor stub
	}

	public BodyResumoBundle(String produtoTitulo, String produtoDescricao,
			...
			com.ucc2.doc.resumo.ItemsBundle[] itemsBundle) {
		super();
	...
	public void setItemsBundle(ItemsBundle[] itemsBundle) {
		ItemsBundle = itemsBundle;
	}
